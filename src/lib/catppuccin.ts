...
/** Nginx 课站独立 storage，避免与其他 learning-* 冲突 */
export const CTP_STORAGE_KEY = "nginx-learn-ctp-flavor";
export const CTP_ACCENT_KEY = "nginx-learn-ctp-accent";
export const DEFAULT_CTP_FLAVOR: CtpFlavor = "mocha";
/** 默认 Teal，贴合 Nginx 品牌色 */
...
export function isCtpAccent(v: string | null | undefined): v is CtpAccent {
  return CTP_ACCENTS.some((f) => f.id === v);
}
